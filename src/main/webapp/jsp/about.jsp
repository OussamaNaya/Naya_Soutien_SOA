                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>killed instructors are able to use effective teaching methods and techniques to deliver
                                content in a way that is both engaging and effective. They are also able to
                                differentiate instruction to meet the needs of all learners.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>Communicate complex concepts clearly and concisely. Skilled instructors are able to
                                communicate complex concepts in a way that is clear and easy to understand. They use
                                plain language and avoid jargon. They also provide examples and illustrations to help
                                students understand the material.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>Home projects are a great way for students to learn new skills, apply what they have
                                learned in class, and take pride in their work. There are many different types of home
                                projects that students can do, depending on their age, skill level, and interests.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>Libraries offer a variety of benefits to their users. They provide access to a wide range
                                of books, including fiction, non-fiction, and children's books.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="../template/img/about.jpg" alt=""
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">.I am so excited to have you here. This website is a resource for you to learn,
                        grow,
                        and succeed. I will be posting regular updates on my courses, as well as additional resources
                        and support materials.</p>
                    <p class="mb-4">I am committed to providing you with the best possible education. I want you to
                        leave my courses feeling confident and prepared for the next step in your journey.
                    </p>
